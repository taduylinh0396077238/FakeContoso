...
namespace ContosoUniversityReal.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(ContosoUniversityRealContext context)
        {
            _context = context;
        }
        ...
        {
            var contosoUniversityRealContext = _context.Departments.Include(d => d.Administrator);
            return View(await contosoUniversityRealContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContosoUniversityRealContext.Departments'  is null.");
            }
